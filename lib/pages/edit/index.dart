...
class EditIndexState extends State<EditIndex> {
  ...
  void initView() {
    if (widget.draft != null) {
      setState(() {
        ...
        content.text = widget.draft.content;
        biaoqian.text = widget.draft.biaoqian;
      });
      for (var i = 0; i < widget.draft.img.length; i++) {
        setState(() {
  ...
  var imgList, isCaogao, imgListUpload = [], imgListNet = [], userId;

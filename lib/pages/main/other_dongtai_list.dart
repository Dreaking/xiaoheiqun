...
class other_dongtai_list extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return other_dongtai_listState();
  }
}

class other_dongtai_listState extends State<other_dongtai_list> {
  List movies, addList;
  int homepage = 1;
  var userId, _control;
  void _listen() {
  ...
  Future getData() async {
    ...
    Tinker.post("/api/product/findProductPageByMerchantId", (data) {
      List top = data["rows"];
      setState(() {
